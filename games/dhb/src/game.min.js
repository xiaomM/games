	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://game.dream623.com",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://game.dream623.com";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://game.dream623.com";
y.url = function() {
	return "http://game.dream623.com?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://game.dream623.com/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://game.dream623.com"
			}, this);
