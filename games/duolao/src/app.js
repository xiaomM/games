...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxData = {
                "appId": "", // 服务号可以填写appId
                "imgUrl" : 'http://game.dream623.com/games/duolao/460.jpg',
                "link" : 'http://game.dream623.com/games/duolao/',
                "desc" : text,
                "title" : '来比记忆力'
            };
            ...
            var wxCallbacks = {
                ...
                all : function(resp) {
                    ...
                    if(window.location) window.location.href = "http://game.dream623.com";
                }
            };
